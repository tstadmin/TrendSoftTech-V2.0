...
const CareersForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://sheet.best/api/sheets/df95d298-d4ba-4992-ba68-4d4b81b05c4c', data).then(response => {
          ...
          >
            ...
            />
             <input type='text'
              className="block w-full p-3 rounded border-black border-2  focus:border-blue-600 focus:outline-none"
              required
              placeholder='Cover Letter' onChange={(e) => setLetter(e.target.value)}
              value={letter}
            />
            ...
            <input type='file'
              className="block w-full p-3 rounded border-black border-2  focus:border-blue-600 focus:outline-none"
              required
              placeholder='Enter your file' onChange={(e) => setResume(e.target.value)}
              value={resume}
            />
            {/* <div>
           <label >Send to Resume to Mail :<a
            ...
            <select className="border-2 rounded-sm border-black" onChange={(e) => setOptions(e.target.value)}>
              <option
                type="text"
              >
                Select position
              </option>
              <option type="text" value="ReactJs Developer" onChange={(e) => setOptions(e.target.value)}>
                ReactJs Developer{" "}
              </option>
              <option type="text" value="Laravel Developer" onChange={(e) => setOptions(e.target.value)}>
                Laravel Developer
              </option>
              <option type="text" value="Web Designer" onChange={(e) => setOptions(e.target.value)}>
                Web Designer
              </option>
            </select>
