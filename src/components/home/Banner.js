  ...
  return (
    <div id="header" role="banner">
      <div
        ...
        className=" font-Poppins 2048Screen:h-[calc(100vh-137px)] 1920Screen:h-[calc(100vh-137px)] xl:h-[calc(100vh-137px)] md:h-[calc(60vh-60px)] sm:h-[calc(60vh-40px)] 540Screen:h-[calc(60vh-137px)] 440Screen:h-[calc(60vh-137px)] 340Screen:h-[calc(60vh-137px)]  h-[calc(120vh-137px)] bg-no-repeat bg-cover bg-center  "
      >
