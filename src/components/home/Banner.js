...
const Banner = props => {
  ...
  const Button = tw.button` text-2xl border  border-blue-500  hover:duration-700  text-blue-500  font-mono hover:bg-blue-500 hover:text-white font-semibold duration-75  px-14 py-2 mb-1 rounded-full`
