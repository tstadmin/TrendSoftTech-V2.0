...
export const BreadCrumInfo = styled.div`
  ${tw` 2xl:top-[40%] top-[35%] w-full  text-center`}
`
...
export const GrowBusinnes = styled.div`
  ${tw`bg-blue-400/25  border border-blue-500  rounded-md p-7 space-y-6 `}
`
...
export const BrochureDiv = styled.div`
  ${tw`mt-10 py-4 px-2 sm:space-x-10 space-x-0 sm:space-y-0 space-y-5 sm:flex w-[100%] justify-center bg-blue-100`}
`
